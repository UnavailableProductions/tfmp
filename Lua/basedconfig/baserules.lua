...
local persist_baserules = {
    "barrier is defeat and not not stop and not not not push and is barrier",
	"border is stop and border",
	"text on border is hide",
	"helichoper is helichoper",
	"text mimic everything",
	"all mimic everything",
	"level mimic everything",
	"beepy pushes glyph",
	"glyph pushes glyph",
	"border is still",
	"idle onon is float and auto",
	"glue is sticky and hold",
	"not lonely glue is push",
	"all on glue is white",
	"onon feeling float is not white",
	"shifty mimic belt",
	"barthollowmew is defeat and not not not push and is barthollowmew and not not stop",
	"frozenbarrier is defeat and not not stop and not not not push and is frozenbarrier",
	"tape is sticky",
    	"all on tape copy tape and is not push",
    	"text on tape copy tape and is not push",
    	"all on tape is not you",
    	"not lonely tape is push",
	"nothing mimic empty",
	"banana mimic 76237529thing",
...
local levelpack_baserules = {
	nothing = {
 		"all and text is weak",
		"level is safe and level and not you",
		},
	something = {
 		"level is red and orange and yellow and green and blue and purple and pink",
		},
	everything = {
		"level is text and baba and wall and keke and key and door and shifty and helichoper and beepy and tape and onon and glue and matthew",
		},
	clothing = {
		"level is shirt and pants",
		}
}
