...
condlist.press_space = function(params,checkedconds)
		return (last_key == 4),checkedconds
	end
condlist.press_s = function(params,checkedconds)
		return (last_key == 3),checkedconds
	end
condlist.press_w = function(params,checkedconds)
		return (last_key == 1),checkedconds
	end
condlist. press_d = function(params,checkedconds)
		return (last_key == 0),checkedconds
	end
condlist.press_a = function(params,checkedconds)
		return (last_key == 2),checkedconds
	end
