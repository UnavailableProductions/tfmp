glyphunits = {}
glyphnouns = { "baba", "glyph", "flag", "keke", "it", "text", "all", "wall", "skull", "empty", "level", "me", "fofo", "water", "badbad", "jiji", "box", "lava", "bog", "key", "door", "hedge", "belt", "rock", "boat", "toometa", "line", "arrow", "cursor", "sign", "tile", "grass", "robot", "monster", "eye", "jelly", "cliff", "love", "cheese","helichoper"}
